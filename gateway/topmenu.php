...
<div class="toolbar overlay-displace-top clearfix toolbar-processed" id="toolbar">
 <div class="toolbar-menu clearfix">
  ...
  <ul id="toolbar-user">
   ...
   <li class="logout last"><a href="<?php echo CMSSITEPATH;?>/login/logout.php">Log out</a></li>
  </ul>
...
<?php		
    ...
    foreach($modules as $m) {
        ...
        $myaccess[] = $name;
        if(in_array($_SESSION['TOPMENU'], $myaccess) && $flag) {
            $active =  'active';
            $flag = false;
        } else {
            $active = '';
...
?>	    
   ...
   <a class="toggle toggle-active toolbar-toggle-processed" title="Hide Icon Legend" href="#" onclick="$('#iconlegend').toggle('slow')">Hide Icon Legend</a>
  </div>
</div>
<div id="iconlegend">
<?php include('iconMenu.php'); ?>
</div>
<div id="blackdivlight" class="blackbg"></div>
