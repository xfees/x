         ...
         <tr>
          ...
          <td class="boxMiddleMiddle">
           <div id="tabs" class="padding12">
            <a <?php echo (RIGHTS != 0) ? 'id="addcontent"' : ''; ?> style="cursor:pointer;" onclick="javascript: $('#sectionname').removeAttr('readonly');"> <span class="iconAdd">&nbsp;</span> <span id="addEditText">Add New </span> <?php echo $curDir ?></a>
           ...
           <div id="editcontent" style="display:none;">
            <div class="contentBox clearfix">
             <form name="dataform">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                <td class="col1 moreP"><?php echo $curDir ?> Name <span class="required">*</span></td>
                 <td class="col2">
                  <input name="name" type="text" class="inputForm" id="sectionname" maxlength="50" /><br/>
                  <font color="#f00">Once saved, <?php echo $curDir ?> name cannot be edited and should not contain any special character</font>
                  <input type="hidden" value="" name="old_sectionname" id="old_sectionname" />
                 </td>
                 <td class="col3">
                  <label class="error" id="sectionname_error">&nbsp;&nbsp;Please Enter <?php echo $curDir ?> Name</label>
                  <label class="error1" id="sectionnameavailable_error" style="font-style: italic;padding-left: 20px;color: red;display:none;">&nbsp;&nbsp;<?php echo $curDir ?> name Already Exists</label>
                 </td>
                </tr>
                <tr>
...
<?php } ?>
                ...
                <tr>
                 ...
                 <td class="col2"><input name="metatitle" type="text" class="inputForm" id="metatitle"  maxlength="600"/></td>
                 <td class="col3">&nbsp;</td>
                </tr>
                <tr>
